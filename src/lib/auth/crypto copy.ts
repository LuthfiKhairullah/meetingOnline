...
// export function decryption(encryptedText: string) {
...
//   const random = crypto.randomBytes(8).toString("hex"); // 16 char
//   const timestamp = Date.now().toString(36); // lebih pendek dari timestamp biasa
